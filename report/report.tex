...
% TODO: talk about the formal aspect here
...
% TODO i think the conclusion should be redone a bit

% show the im2col operation
% replace the instructions 
% show the library 
% now talk about the indexing operations 
% segue to optitrust, same as presentation
% Show a subset of the conv1d optimization. "Optitrust supports many of the same scheduling directives as Exo and TVM. For example, here's how to do blah blah blah. Thanks to the extensibility of the language, you can also add transformations to do something yourself". Show how we implemented unification modulo windowing with our own expressions to extract windows.
% But there's one thing that you cannot extend the language with, inherently. Since optitrust is bound to the C spec, it won't work with inline asm. That limits us once again, blah blah blah. 

% Conclusion time, then future work
