...
entry:
  ...
  call void @llvm.dbg.declare(metadata ptr %0, metadata !12, metadata !DIExpression()), !dbg !18
  store ptr %args, ptr %0, align 4, !dbg !18
  %1 = alloca ptr, align 4, !dbg !18
  call void @llvm.dbg.declare(metadata ptr %1, metadata !13, metadata !DIExpression()), !dbg !18
  store ptr %arg_type_ids, ptr %1, align 4, !dbg !18
  %2 = alloca i32, align 4, !dbg !18
  call void @llvm.dbg.declare(metadata ptr %2, metadata !14, metadata !DIExpression()), !dbg !18
  store i32 %num_args, ptr %2, align 4, !dbg !18
  %3 = alloca ptr, align 4, !dbg !18
  call void @llvm.dbg.declare(metadata ptr %3, metadata !15, metadata !DIExpression()), !dbg !18
  store ptr %out_ret_value, ptr %3, align 4, !dbg !18
  %4 = alloca ptr, align 4, !dbg !18
  call void @llvm.dbg.declare(metadata ptr %4, metadata !16, metadata !DIExpression()), !dbg !18
...
assert_end:                                       ; preds = %entry
  ...
  call void @llvm.dbg.declare(metadata i32 %A_handle.code, metadata !34, metadata !DIExpression()), !dbg !18
  call void @llvm.dbg.declare(metadata i32 %A_handle.code, metadata !34, metadata !DIExpression()), !dbg !18
  %9 = getelementptr inbounds i32, ptr %arg_type_ids, i32 1, !dbg !18
  %B_handle.code = load i32, ptr %9, align 4, !dbg !18, !tbaa !35
  call void @llvm.dbg.declare(metadata i32 %B_handle.code, metadata !37, metadata !DIExpression()), !dbg !18
  call void @llvm.dbg.declare(metadata i32 %B_handle.code, metadata !37, metadata !DIExpression()), !dbg !18
  %10 = getelementptr inbounds i32, ptr %arg_type_ids, i32 2, !dbg !18
  %C_handle.code = load i32, ptr %10, align 4, !dbg !18, !tbaa !38
  call void @llvm.dbg.declare(metadata i32 %C_handle.code, metadata !41, metadata !DIExpression()), !dbg !18
  call void @llvm.dbg.declare(metadata i32 %C_handle.code, metadata !41, metadata !DIExpression()), !dbg !18
  %11 = getelementptr inbounds %0, ptr %args, i32 0, !dbg !18
  %A_handle = load ptr, ptr %11, align 4, !dbg !18
  call void @llvm.dbg.declare(metadata ptr %A_handle, metadata !42, metadata !DIExpression()), !dbg !18
  call void @llvm.dbg.declare(metadata ptr %A_handle, metadata !42, metadata !DIExpression()), !dbg !18
  %12 = getelementptr inbounds %0, ptr %args, i32 1, !dbg !18
  %B_handle = load ptr, ptr %12, align 4, !dbg !18
  call void @llvm.dbg.declare(metadata ptr %B_handle, metadata !43, metadata !DIExpression()), !dbg !18
  call void @llvm.dbg.declare(metadata ptr %B_handle, metadata !43, metadata !DIExpression()), !dbg !18
  %13 = getelementptr inbounds %0, ptr %args, i32 2, !dbg !18
  %C_handle = load ptr, ptr %13, align 4, !dbg !18
  call void @llvm.dbg.declare(metadata ptr %C_handle, metadata !44, metadata !DIExpression()), !dbg !18
  call void @llvm.dbg.declare(metadata ptr %C_handle, metadata !44, metadata !DIExpression()), !dbg !18
  %14 = getelementptr inbounds %1, ptr %A_handle, i32 0, i32 0, !dbg !18
  %A = load ptr, ptr %14, align 4, !dbg !18
  call void @llvm.dbg.declare(metadata ptr %A, metadata !45, metadata !DIExpression()), !dbg !18
  call void @llvm.dbg.declare(metadata ptr %A, metadata !45, metadata !DIExpression()), !dbg !18
  ...
  call void @llvm.dbg.declare(metadata ptr %before_tensorize.A_handle.shape, metadata !48, metadata !DIExpression()), !dbg !18
  call void @llvm.dbg.declare(metadata ptr %before_tensorize.A_handle.shape, metadata !48, metadata !DIExpression()), !dbg !18
  ...
  call void @llvm.dbg.declare(metadata ptr %before_tensorize.A_handle.strides, metadata !51, metadata !DIExpression()), !dbg !18
  call void @llvm.dbg.declare(metadata ptr %before_tensorize.A_handle.strides, metadata !51, metadata !DIExpression()), !dbg !18
  %17 = getelementptr inbounds %1, ptr %A_handle, i32 0, i32 1, i32 1, !dbg !18
  %dev_id = load i32, ptr %17, align 4, !dbg !18
  call void @llvm.dbg.declare(metadata i32 %dev_id, metadata !52, metadata !DIExpression()), !dbg !18
  call void @llvm.dbg.declare(metadata i32 %dev_id, metadata !52, metadata !DIExpression()), !dbg !18
  %18 = getelementptr inbounds %1, ptr %B_handle, i32 0, i32 0, !dbg !18
  %B = load ptr, ptr %18, align 4, !dbg !18
  call void @llvm.dbg.declare(metadata ptr %B, metadata !53, metadata !DIExpression()), !dbg !18
  call void @llvm.dbg.declare(metadata ptr %B, metadata !53, metadata !DIExpression()), !dbg !18
  ...
  call void @llvm.dbg.declare(metadata ptr %before_tensorize.B_handle.shape, metadata !54, metadata !DIExpression()), !dbg !18
  call void @llvm.dbg.declare(metadata ptr %before_tensorize.B_handle.shape, metadata !54, metadata !DIExpression()), !dbg !18
  ...
  call void @llvm.dbg.declare(metadata ptr %before_tensorize.B_handle.strides, metadata !55, metadata !DIExpression()), !dbg !18
  call void @llvm.dbg.declare(metadata ptr %before_tensorize.B_handle.strides, metadata !55, metadata !DIExpression()), !dbg !18
  %21 = getelementptr inbounds %1, ptr %C_handle, i32 0, i32 0, !dbg !18
  %C = load ptr, ptr %21, align 4, !dbg !18
  call void @llvm.dbg.declare(metadata ptr %C, metadata !56, metadata !DIExpression()), !dbg !18
  call void @llvm.dbg.declare(metadata ptr %C, metadata !56, metadata !DIExpression()), !dbg !18
  ...
  call void @llvm.dbg.declare(metadata ptr %before_tensorize.C_handle.shape, metadata !57, metadata !DIExpression()), !dbg !18
  call void @llvm.dbg.declare(metadata ptr %before_tensorize.C_handle.shape, metadata !57, metadata !DIExpression()), !dbg !18
  ...
  call void @llvm.dbg.declare(metadata ptr %before_tensorize.C_handle.strides, metadata !58, metadata !DIExpression()), !dbg !18
  call void @llvm.dbg.declare(metadata ptr %before_tensorize.C_handle.strides, metadata !58, metadata !DIExpression()), !dbg !18
...
for_begin_i_0:                                    ; preds = %for_end_j_0, %entry
  ...
  call void @llvm.dbg.declare(metadata i32 %i_0, metadata !67, metadata !DIExpression()), !dbg !66
...
for_begin_j_0:                                    ; preds = %for_end_k_0, %for_body_i_0
  ...
  call void @llvm.dbg.declare(metadata i32 %j_0, metadata !68, metadata !DIExpression()), !dbg !66
...
for_begin_k_0:                                    ; preds = %for_body_k_0, %for_body_j_0
  ...
  call void @llvm.dbg.declare(metadata i32 %k_0, metadata !69, metadata !DIExpression()), !dbg !66
...
for_body_k_0:                                     ; preds = %for_begin_k_0
  ...
  call void @llvm.dbg.declare(metadata i32 %cse_var_1, metadata !70, metadata !DIExpression()), !dbg !66
  call void @llvm.dbg.declare(metadata i32 %cse_var_1, metadata !70, metadata !DIExpression()), !dbg !66
;  call void @llvm.riscv.mcfg(i32 1049604), !dbg !66
  %7 = getelementptr inbounds float, ptr %C, i32 %cse_var_1, !dbg !66
;  call void @llvm.riscv.mld.w(i32 2, ptr %7, i32 64), !dbg !66
...
;  call void @llvm.riscv.mst.w(i32 2, ptr %8, i32 64), !dbg !66
;  call void @llvm.riscv.fmmacc.s(i32 2, i32 1, i32 0), !dbg !66
  %9 = getelementptr inbounds float, ptr %C, i32 %cse_var_1, !dbg !66
  call void @llvm.x86.tilestoredd64(i8 1, ptr %9, i64 64)
;  call void @llvm.riscv.mst.w(i32 2, ptr %9, i32 64), !dbg !66
...
;declare void @llvm.riscv.mcfg(i32) #3

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(read)
;declare void @llvm.riscv.mld.w(i32 immarg, ptr, i32) #4

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(write)
;declare void @llvm.riscv.mst.w(i32 immarg, ptr, i32) #5

; Function Attrs: nocallback nofree nosync nounwind willreturn
;declare void @llvm.riscv.fmmacc.s(i32 immarg, i32 immarg, i32 immarg) #3
...
attributes #6 = { nounwind memory(none) "target-cpu"="generic" "target-features" }
